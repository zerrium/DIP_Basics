  ...
  for y:=0 to image1.Height-1 do
    begin
      ...
      begin
        ...
        manipG[x,y] := IfThen(defaultBrightnessG[x,y] < 0, 0, IfThen(defaultBrightnessG[x,y] > 255, 255, defaultBrightnessG[x,y]));
        manipB[x,y] := IfThen(defaultBrightnessB[x,y] < 0, 0, IfThen(defaultBrightnessB[x,y] > 255, 255, defaultBrightnessB[x,y]));
      end;
    end;
